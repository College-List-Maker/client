      ...
      <Grid templateColumns="repeat(2, 1fr)" gap={1}>
        <InputGroup>
          <Checkbox
            ...
            defaultChecked={
              formData.locationPrefs.locationImportance ? true : false
            }
          >
        ...
        <>
          <InputGroup>
            <Checkbox
              ...
              defaultChecked={
                formData.locationPrefs.livingAtHome ? true : false
              }
            >
          ...
          <InputGroup>
            <Select
              ...
              defaultValue={String(formData.locationPrefs.curState)}
              required
              ref={curStateRef}
            >
          ...
          <InputGroup>
            ...
            <Input
              ...
              type="text"
              defaultValue={String(formData.locationPrefs.prefCity)}
              required
              ref={prefCityRef}
            />
          </InputGroup>
          ...
          <InputGroup>
            <Select
              ...
              defaultValue={String(formData.locationPrefs.prefState)}
              required
              ref={prefStateRef}
            >
              <option value="AL">Alabama</option>
        ...
        <Grid templateColumns="repeat(1, 1fr)" gap={1}>
          <InputGroup>
            <Select
              ...
              defaultValue={String(formData.locationPrefs.prefRegion)}
              required
              ref={prefRegionRef}
            >
          ...
          <InputGroup>
            <Select
              ...
              defaultValue={String(formData.locationPrefs.prefLocale)}
              required
              ref={prefLocaleRef}
            >
              <option value="11">
        ...
        <Grid templateColumns="repeat(2, 1fr)" gap={1}>
          <InputGroup>
            ...
            <Input
              ...
              type="number"
              defaultValue={String(formData.locationPrefs.prefSummerClimate)}
              required
              ref={prefSumTempRef}
            />
          </InputGroup>
          <InputGroup>
            ...
            <Input
              ...
              type="number"
              defaultValue={String(formData.locationPrefs.prefWinterClimate)}
              required
              ref={prefWinTempRef}
            />
          </InputGroup>
