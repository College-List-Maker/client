        ...
        <>
            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={1}>
                ...
                <InputGroup>
                    ...
                    <Input
                        ...
                        type="number"
                        defaultValue={String(
                            formData.collegePrefs.prefSexRatioF
                        )}
                        required
                        min={0}
                        max={100}
            ...
            <FormControl isRequired>
                <RadioGroup
                    ref={sameGenRef}
                    defaultValue={String(
                        formData.collegePrefs.sameGenderImportance
                    )}
                >
                    <Heading as="h3" size="sm">
            ...
            <Grid templateColumns="repeat(3, 1fr)" gap={1}>
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.collegePrefs.facilityImportance
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.collegePrefs.prefPublicControl
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.collegePrefs.prefPrivateControl
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.collegePrefs.pref4yr ? true : false
                        }
                    >
                        Pref 4yr
                    </Checkbox>
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.collegePrefs.prefReligious ? true : false
                        }
                    >
                        Pref Religious
                    </Checkbox>
                ...
                <InputGroup>
                    <Select
                        ...
                        defaultValue={String(
                            formData.collegePrefs.prefReligion
                        )}
                        required
                        ref={prefReligionRef}
                    >
            ...
            <FormControl isRequired>
                <RadioGroup
                    ...
                    defaultValue={String(
                        formData.collegePrefs.prefCommittedFaculty
                    )}
                >
                    <Heading as="h3" size="sm">
