            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={1}>
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.successPrefs.successImportance
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.successPrefs.alumniCarreerImportance
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.successPrefs.graduationRateImportance
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    ...
                    <Input
                        ...
                        type="number"
                        defaultValue={String(
                            formData.successPrefs.prefGraduationRate
                        )}
                        required
                        min={0}
                        max={100}
                ...
                <InputGroup>
                    <Checkbox
                        ...
                        defaultChecked={
                            formData.successPrefs.retentionRateImportance
                                ? true
                                : false
                        }
                    >
                ...
                <InputGroup>
                    ...
                    <Input
                        ...
                        type="number"
                        defaultValue={String(
                            formData.successPrefs.prefRetentionRate
                        )}
                        required
                        min={0}
                        max={100}
                ...
                <InputGroup>
                    ...
                    <Input
                        ...
                        type="number"
                        defaultValue={String(
                            formData.successPrefs.desiredEarnings
                        )}
                        required
                        min={0}
                        ref={prefEarnRef}
