        ...
        <>
            ...
            <FormControl isRequired>
                <RadioGroup
                    ref={prestRef}
                    defaultValue={String(
                        formData.collegePrefs.prestiegeImportance
                    )}
                >
            ...
            <FormControl isRequired>
                <RadioGroup
                    ref={internRef}
                    defaultValue={String(
                        formData.collegePrefs.internshipImportance
                    )}
                >
                    <Heading as="h3" size="sm">
            ...
            <FormControl isRequired>
                <RadioGroup
                    ref={studyAbrRef}
                    defaultValue={String(
                        formData.collegePrefs.studyAbroadImportance
                    )}
                >
                    <Heading as="h3" size="sm">
            ...
            <FormControl isRequired>
                <RadioGroup
                    ref={workStudyRef}
                    defaultValue={String(
                        formData.collegePrefs.workStudyImportance
                    )}
                >
                    <Heading as="h3" size="sm">
            ...
            <FormControl isRequired>
                <RadioGroup
                    ref={resRef}
                    defaultValue={String(
                        formData.collegePrefs.researchImportance
                    )}
                >
                    <Heading as="h3" size="sm">
                        Research Importance
