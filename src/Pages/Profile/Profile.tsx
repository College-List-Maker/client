...
export function Profile(): {
    ...
    const defaultData = {
        academic: {
            gpa: submissionData?.academic.gpa
                ? submissionData?.academic.gpa
                : -1,
            sat: submissionData?.academic.sat
                ? submissionData?.academic.sat
                : -1,
            act: submissionData?.academic.act
                ? submissionData?.academic.act
                : -1,
        },
        courseload: {
            ...
            lang: submissionData?.courseload.lang
                ...
                : -1,
            cs: submissionData?.courseload.cs
                ? submissionData?.courseload.cs
                : "",
        ...
        collegePrefs: {
            ...
            hbcuImportance: submissionData?.collegePrefs.hbcuImportance
                ...
                : -1,
            internshipImportance: submissionData?.collegePrefs
            ...
            pref4yr: submissionData?.collegePrefs.pref4yr
                ...
                : false,
            prefCommittedFaculty: submissionData?.collegePrefs
            ...
            prefSize: submissionData?.collegePrefs.prefSize
                ...
                : -1,
            prestiegeImportance: submissionData?.collegePrefs
                .prestiegeImportance
            ...
            rigorImportance: submissionData?.collegePrefs.rigorImportance
                ...
                : -1,
            sameGenderImportance: submissionData?.collegePrefs
                .sameGenderImportance
                ? submissionData.collegePrefs.sameGenderImportance
                : -1,
            studyAbroadImportance: submissionData?.collegePrefs
                .studyAbroadImportance
                ? submissionData.collegePrefs.studyAbroadImportance
                : -1,
            workStudyImportance: submissionData?.collegePrefs
                .workStudyImportance
