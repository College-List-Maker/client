...
export function SpecificExplore({ collegeData }: SpecificExploreInt) {
    ...
    function getLargestValues(collegeData: {
        [key: string]: number;
    }): string[] {
        let pcipNames: string[] = [];
        console.log("test");
        const pcipValues = Object.entries(collegeData).filter(([key]) =>
            key.startsWith("PCIP")
        );
                    ...
                    <Stack>
                        <Stack color={"white"}>
                            ...
                            <Text>
                                ...
                                {collegeData.CONTROL == 1
                                    ? "public"
                                    : collegeData.CONTROL == 2
                                    ? "private, nonprofit"
                                    : collegeData.CONTROL == 3
                                    ? "private, for-profit"
                                    : ""}{" "}
                                institution of higher education that
                                predominantly offers{" "}
                                {collegeData.ICLEVEL == 1
                                    ? "4-year"
                                    : collegeData.ICLEVEL == 2
                                    ? "2-year"
                                    : collegeData.ICLEVEL == 3
                                    ? "less than 2-year"
                                    : ""}{" "}
                                programs. It is located in {collegeData.CITY},{" "}
                                {collegeData.STABBR} and offers a variety of
                                degree programs
                                {collegeData.HIGHDEG == 0
                                    ? ""
                                    : collegeData.HIGHDEG == 1
                                    ? " at the certificate level"
                                    : collegeData.HIGHDEG == 2
                                    ? " at the certificate and associate level"
                                    : collegeData.HIGHDEG == 3
                                    ? " at the associate and bachelor level"
                                    : collegeData.HIGHDEG == 4
                                    ? " at the associate, bachelor, and graduate level"
                                    : ""}
                                . {collegeData.INSTNM} is home to about{" "}
                                {formatAsNumber(collegeData.UGDS)} college
                                students, and with an acceptance rate of{" "}
                                {(collegeData.ADM_RATE * 100).toFixed(2)}%, is
                                classified as{" "}
                                {collegeData.ADM_RATE < 0.15
                                    ? "a most selective"
                                    : collegeData.ADM_RATE < 0.35
                                    ? "an extremely selective"
                                    : collegeData.ADM_RATE < 0.5
                                    ? "a very selective"
                                    : collegeData.ADM_RATE < 0.6
                                    ? "a moderately selective"
                                    : "a selective"}{" "}
                                university. For more on {collegeData.INSTNM},
                                view the comprehesive statistics below or visit
                                their website at{" "}
                                <Link
                ...
                <Stack>
                    <StatCard
                        ...
                        stats={[
                            ...
                            },
                            {
                                stat:
                                    (
                                        collegeData.COMP_ORIG_YR4_RT * 100
                                    ).toFixed(2) + "%",
                            ...
                            },
                            {
                                stat:
                                    (
                                        100 -
                                        collegeData.WDRAW_ORIG_YR4_RT * 100
                                    ).toFixed(2) + "%",
                    ...
                    <StatCard
                        ...
                        stats={[
                            {
                                stat:
                                    (collegeData.ADM_RATE * 100).toFixed(2) +
                                    "%",
                                desc: "Acceptance Rate",
                            },
                            {
                                stat:
                                    collegeData.ADMCON7 == 1
                                        ? "Required"
                                        : collegeData.ADMCON7 == 2
                                        ? "Recommended"
                                        : collegeData.ADMCON7 == 3
                                        ? "Neither recommended nor required"
                                        : collegeData.ADMCON7 == 5
                        ...
                        stats={[
                            ...
                            },
                            {
                                stat: formatAsCurrency(
                                    collegeData.MD_EARN_WNE_P6
                                ),
                                desc: "Median 6yr Earnings",
                            },
                            {
                                stat: formatAsCurrency(
                                    collegeData.MEDIAN_HH_INC
                                ),
